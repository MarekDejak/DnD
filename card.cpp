    ...
    ui(new Ui::Card)
{
   ...
   ui->lvlUp->setStyleSheet("font: 12pt ""Cooper Black"";"
                                  "color: rgb(255, 255, 127);");
...
Ptaszki Card::getPtaszki(){
    ...
    for(int i=0; i<m_characters.size(); i++){
        if(m_name == m_characters[i].getName()){
            ...
            if(m_ptaszki.size() != 0){
                if(ui->atletykaB->isChecked()){m_ptaszki[i]["Atletyka"] = true;} // zapamietanie ptaszkow QCheckBox
                else{m_ptaszki[i]["Atletyka"] = false;}
                if(ui->akrobatykaB->isChecked()){m_ptaszki[i]["Akrobatyka"] = true;}
                else{m_ptaszki[i]["Akrobatyka"] = false;}
                if(ui->blokB->isChecked()){m_ptaszki[i]["Blok"] = true;}
                else{m_ptaszki[i]["Blok"] = false;}
                if(ui->brakMunB->isChecked()){m_ptaszki[i]["Brak munduru"] = true;}
                else{m_ptaszki[i]["Brak munduru"] = false;}
                if(ui->bronDwuB->isChecked()){m_ptaszki[i]["Bron dwureczna"] = true;}
                else{m_ptaszki[i]["Bron dwureczna"] = false;}
                if(ui->celnoscB->isChecked()){m_ptaszki[i]["Celnosc"] = true;}
                else{m_ptaszki[i]["Celnosc"] = false;}
                if(ui->ciezkiMunB->isChecked()){m_ptaszki[i]["Ciezki mundur"] = true;}
                else{m_ptaszki[i]["Ciezki mundur"] = false;}
                if(ui->czytanieB->isChecked()){m_ptaszki[i]["Czytanie"] = true;}
                else{m_ptaszki[i]["Czytanie"] = false;}
                if(ui->dlugieOstB->isChecked()){m_ptaszki[i]["Dlugie ostrza"] = true;}
                else{m_ptaszki[i]["Dlugie ostrza"] = false;}
                if(ui->dzidaB->isChecked()){m_ptaszki[i]["Dzida"] = true;}
                else{m_ptaszki[i]["Dzida"] = false;}
                if(ui->handelB->isChecked()){m_ptaszki[i]["Handel"] = true;}
                else{m_ptaszki[i]["Handel"] = false;}
                if(ui->iluzjaB->isChecked()){m_ptaszki[i]["Iluzja"] = true;}
                else{m_ptaszki[i]["Iluzja"] = false;}
                if(ui->kierowanieB->isChecked()){m_ptaszki[i]["Kierowanie pojazdami"] = true;}
                else{m_ptaszki[i]["Kierowanie pojazdami"] = false;}
                if(ui->kosmobiologiaB->isChecked()){m_ptaszki[i]["Kosmobiologia"] = true;}
                else{m_ptaszki[i]["Kosmobiologia"] = false;}
                if(ui->krotkieOstB->isChecked()){m_ptaszki[i]["Krotkie ostrza"] = true;}
                else{m_ptaszki[i]["Krotkie ostrza"] = false;}
                if(ui->kutarateB->isChecked()){m_ptaszki[i]["Kutarate/chudo"] = true;}
                else{m_ptaszki[i]["Kutarate/chudo"] = false;}
                if(ui->lekkiMunB->isChecked()){m_ptaszki[i]["Lekki mundur"] = true;}
                else{m_ptaszki[i]["Lekki mundur"] = false;}
                if(ui->lepkieB->isChecked()){m_ptaszki[i]["Lepkie lapy"] = true;}
                else{m_ptaszki[i]["Lepkie lapy"] = false;}
                if(ui->medycynaB->isChecked()){m_ptaszki[i]["Medycyna"] = true;}
                else{m_ptaszki[i]["Medycyna"] = false;}
                if(ui->obslugaCSB->isChecked()){m_ptaszki[i]["Obsluga ciezkiego sprzetu"] = true;}
                else{m_ptaszki[i]["Obsluga ciezkiego sprzetu"] = false;}
                if(ui->przyczajkaB->isChecked()){m_ptaszki[i]["Przyczajka"] = true;}
                else{m_ptaszki[i]["Przyczajka"] = false;}
                if(ui->przywracanieB->isChecked()){m_ptaszki[i]["Przywracanie"] = true;}
                else{m_ptaszki[i]["Przywracanie"] = false;}
                if(ui->rozpierduchaB->isChecked()){m_ptaszki[i]["Rozpierducha"] = true;}
                else{m_ptaszki[i]["Rozpierducha"] = false;}
                if(ui->sumoB->isChecked()){m_ptaszki[i]["Sumo"] = true;}
                else{m_ptaszki[i]["Sumo"] = false;}
                if(ui->transmutacjaB->isChecked()){m_ptaszki[i]["Transmutacja"] = true;}
                else{m_ptaszki[i]["Transmutacja"] = false;}
                if(ui->zabobonyB->isChecked()){m_ptaszki[i]["Zabobony"] = true;}
                else{m_ptaszki[i]["Zabobony"] = false;}
                if(ui->zlotyJezykB->isChecked()){m_ptaszki[i]["Zloty jezyk"] = true;}
                else{m_ptaszki[i]["Zloty jezyk"] = false;}
            }
        }
    }
...
void Card::setPtaszki(Ptaszki input){
    ...
    for(int i=0; i<m_characters.size(); i++){
        if(m_name == m_characters[i].getName()){
            ...
            if(m_ptaszki[i]["Atletyka"] == true){ui->atletykaB->setChecked(true);}
            else{ui->atletykaB->setChecked(false);}
            if(m_ptaszki[i]["Akrobatyka"] == true){ui->akrobatykaB->setChecked(true);}
            else{ui->akrobatykaB->setChecked(false);}
            if(m_ptaszki[i]["Blok"] == true){ui->blokB->setChecked(true);}
            else{ui->blokB->setChecked(false);}
            if(m_ptaszki[i]["Brak munduru"] == true){ui->brakMunB->setChecked(true);}
            else{ui->brakMunB->setChecked(false);}
            if(m_ptaszki[i]["Bron dwureczna"] == true){ui->bronDwuB->setChecked(true);}
            else{ui->bronDwuB->setChecked(false);}
            if(m_ptaszki[i]["Celnosc"] == true){ui->celnoscB->setChecked(true);}
            else{ui->celnoscB->setChecked(false);}
            if(m_ptaszki[i]["Ciezki mundur"] == true){ui->ciezkiMunB->setChecked(true);}
            else{ui->ciezkiMunB->setChecked(false);}
            if(m_ptaszki[i]["Czytanie"] == true){ui->czytanieB->setChecked(true);}
            else{ui->czytanieB->setChecked(false);}
            if(m_ptaszki[i]["Dlugie ostrza"] == true){ui->dlugieOstB->setChecked(true);}
            else{ui->dlugieOstB->setChecked(false);}
            if(m_ptaszki[i]["Dzida"] == true){ui->dzidaB->setChecked(true);}
            else{ui->dzidaB->setChecked(false);}
            if(m_ptaszki[i]["Handel"] == true){ui->handelB->setChecked(true);}
            else{ui->handelB->setChecked(false);}
            if(m_ptaszki[i]["Iluzja"] == true){ui->iluzjaB->setChecked(true);}
            else{ui->iluzjaB->setChecked(false);}
            if(m_ptaszki[i]["Kierowanie pojazdami"] == true){ui->kierowanieB->setChecked(true);}
            else{ui->kierowanieB->setChecked(false);}
            if(m_ptaszki[i]["Kosmobiologia"] == true){ui->kosmobiologiaB->setChecked(true);}
            else{ui->kosmobiologiaB->setChecked(false);}
            if(m_ptaszki[i]["Krotkie ostrza"] == true){ui->krotkieOstB->setChecked(true);}
            else{ui->krotkieOstB->setChecked(false);}
            if(m_ptaszki[i]["Kutarate/chudo"] == true){ui->kutarateB->setChecked(true);}
            else{ui->kutarateB->setChecked(false);}
            if(m_ptaszki[i]["Lekki mundur"] == true){ui->lekkiMunB->setChecked(true);}
            else{ui->lekkiMunB->setChecked(false);}
            if(m_ptaszki[i]["Lepkie lapy"] == true){ui->lepkieB->setChecked(true);}
            else{ui->lepkieB->setChecked(false);}
            if(m_ptaszki[i]["Medycyna"] == true){ui->medycynaB->setChecked(true);}
            else{ui->medycynaB->setChecked(false);}
            if(m_ptaszki[i]["Obsluga ciezkiego sprzetu"] == true){ui->obslugaCSB->setChecked(true);}
            else{ui->obslugaCSB->setChecked(false);}
            if(m_ptaszki[i]["Przyczajka"] == true){ui->przyczajkaB->setChecked(true);}
            else{ui->przyczajkaB->setChecked(false);}
            if(m_ptaszki[i]["Przywracanie"] == true){ui->przywracanieB->setChecked(true);}
            else{ui->przywracanieB->setChecked(false);}
            if(m_ptaszki[i]["Rozpierducha"] == true){ui->rozpierduchaB->setChecked(true);}
            else{ui->rozpierduchaB->setChecked(false);}
            if(m_ptaszki[i]["Sumo"] == true){ui->sumoB->setChecked(true);}
            else{ui->sumoB->setChecked(false);}
            if(m_ptaszki[i]["Transmutacja"] == true){ui->transmutacjaB->setChecked(true);}
            else{ui->transmutacjaB->setChecked(false);}
            if(m_ptaszki[i]["Zabobony"] == true){ui->zabobonyB->setChecked(true);}
            else{ui->zabobonyB->setChecked(false);}
            if(m_ptaszki[i]["Zloty jezyk"] == true){ui->zlotyJezykB->setChecked(true);}
            else{ui->zlotyJezykB->setChecked(false);}
        }
    }
}
...
void Card::onLvlUpClicked(){
    ...
    for(int i=0; i<m_characters.size(); i++){
        if(m_name == m_characters[i].getName()){
            ...
            for(auto x: coWeszlo){
                if(x.second == true) ileSkilliWeszlo++;
            }
        }
    }
...
//         connect(lvl, &Lvl::saved, this, &Card::close); // zamkniecie karty gdy lvl sie zamknie
        ...
        nothingLvled.setStyleSheet("background-image: url(:/images/images/tlo1.jpg);"
